...
export const CharacterCard = ({
    ...
    const addSpell = () => {
        if (newSpell.name.trim()) {
            const newSpellSlots = Number.isNaN(+newSpell.slots)
                ? 0
                : newSpell.slots;
            ...
            setLocalCharacter((prev) => ({
                ...
                spells: [
                    ...prev.spells,
                    {
                        ...
                        checkedSlots: Array(parseInt(newSpellSlots, 10)).fill(
                            true
                        ),
                    },
                ],
    ...
    const confirmImportCharacter = () => {
        ...
        const foundCharacter = importedCharacters.find(
            (c) => c.id === selectedImportedCharacter
        );
        if (foundCharacter) {
                ...
                <div className="flex flex-col flex-wrap">
                    {importedCharacters.length > 0 && (
                        <div className="mb-6">
                            <select
                                ...
                                onChange={(e) =>
                                    setSelectedImportedCharacter(e.target.value)
                                }
                    ...
                    <div className="mt-4">
                        ...
                        {localCharacter.spells.map((spell, index) => (
                            <div
                                key={index}
                                className="flex space-x-2 mt-2 items-center"
                            >
                                <input
                                    type="text"
                                    name="name"
                    ...
                    <div className="flex justify-between items-center mb-4">
                        <div className="flex items-center space-x-6">
                            ...
                            <div className="flex items-center space-x-2">
                                <p className="text-sm dark:text-slate-400 text-gray-500 mb-0">
                                    <strong>Life:</strong>{' '}
                                    {localCharacter.currentLife}/
                                    {localCharacter.fullLife}
                                </p>
                                <button

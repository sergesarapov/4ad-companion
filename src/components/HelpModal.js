                    ...
                    <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                        ...
                        <ul className="space-y-2">
                            <li className="flex items-start">
                                ...
                                <span><strong>Dungeon Rolling:</strong> Use the dice roll buttons at the top of the page to define room shape, contents, encounters, and treasure</span>
                            </li>
                            <li className="flex items-start">
                            ...
                            <li className="flex items-start">
                                <span className="mr-2">🏹</span>
                                <span><strong>Character Management:</strong> Keep track of four heroes, including their stats, equipment, and spells</span>
                            </li>
                            <li className="flex items-start">
                                <span className="mr-2">👹</span>
                                <span><strong>Encounter Tracking:</strong> Manage and track various encounters throughout your adventure</span>
                            </li>
                            <li className="flex items-start">
                                <span className="mr-2">📜</span>
                                <span><strong>Adventure Logging:</strong> Keep track of your adventures with short log entries</span>
                            </li>
                            <li className="flex items-start">
                                <span className="mr-2">📚</span>
                                <span><strong>Persistent Storage:</strong> Your dungeon, characters, and encounters are automatically saved</span>
                            </li>
                            <li className="flex items-start">
                                <span className="mr-2">🏰</span>
                                <span><strong>Save/Load Functionality:</strong> Export your dungeon to a JSON file and load it on different devices</span>
                            </li>
                        </ul>
                    </div>
